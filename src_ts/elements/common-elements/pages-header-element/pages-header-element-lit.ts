...
import {pagesHeaderElementStyles} from './pages-header-element-styles-lit';
 ...
 * @LitElement
 */
@customElement('pages-header-element-lit')
export class PagesHeaderElement extends MatomoMixin(LitElement) {
  ...
  @property({type: Boolean, reflect: true, attribute: 'show-print-button'})
