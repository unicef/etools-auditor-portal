...
export const StatusTabElementStyles = html`
  <style>
    :host {
      display: block;
    ...
    .status-list { width: 100%; padding: 24px; box-sizing: border-box; }
    .status-buttons {
      width: 100%;
      padding: 24px;
    ...
    .status-container .status-icon, .status-container .status {
      @apply --layout-vertical;
      @apply --layout-center-justified;
      @apply --layout-warp;
    }
    .status-container iron-icon { display: inline-block !important; }
