...
function EngagementMixin <T extends Constructor<PolymerElement>>(baseClass: T){
    class EngagementMixin extends (baseClass){
        ...
        _infoLoaded() {
            //save data copy
            this._setOriginalData(cloneDeep(this.engagement));
        ...
        _engagementUpdated(event) {
            ...
            if (data) { this._setOriginalData(cloneDeep(this.engagement)); }
        ...
        _getBasicInfo(data) {
            ...
            if (engagementDetailsData) { assign(data, engagementDetailsData); }
            if (partnerDetailsData) { assign(data, partnerDetailsData); }
        ...
        _errorOccurred(errorObj) {
            if (!errorObj || !isObject(errorObj)) { return; }
