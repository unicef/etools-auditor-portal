Polymer({
  ...
  toggleDrawer: function() {
    const isClosed = !this.$.drawer.opened;
    let drawerWidth;
  ...
  queueToast: function(e, detail) {
    const notificationList = Polymer.dom(this.root).querySelector('multi-notification-list');
  ...
  _configPath: function() {
    const path = `${this.basePath}engagements/list`;
